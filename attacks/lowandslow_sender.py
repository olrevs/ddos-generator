...
def build_socket(destination_ip, destination_port):
...
def start_slowloris(destination_ip, destination_port, socket_count):
    ...
    for i in range(socket_count):
        try:
            ...
            s = build_socket(destination_ip, destination_port)
        except socket.error:
            break
